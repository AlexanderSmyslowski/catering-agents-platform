...
export const llmReadinessPromptArtifactRegistryVersion = "llm-readiness-prompt-artifact-registry-v0";
...
export function findLlmReadinessPromptArtifactByInputKind(inputKind) {
  return llmReadinessPromptArtifacts.find((artifact) => artifact.inputKind === inputKind);
}

export function validateLlmReadinessPromptArtifacts() {
  const errors = [];
