export const productionHandoffSchema = {
  ...
  properties: {
    ...
    eventSpecSnapshot: { $ref: "https://schemas.catering.local/accepted-event-spec.json" },
    sourceAcceptedEventSpecSnapshot: { $ref: "https://schemas.catering.local/accepted-event-spec.json" },
    pricingSnapshot: { $ref: "https://schemas.catering.local/common.json#/$defs/pricingSummary" },
