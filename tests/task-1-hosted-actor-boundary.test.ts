...
describe("hosted builder actor boundary", () => {
  it("rejects Intake before the first store write when the trusted business id is missing", async () => {
    ...
    try {
      ...
      expect(response.json().message).toContain("Vertrauenswürdiger Betriebskontext erforderlich");
  ...
  it("rejects Offer before the first store read when the trusted business id is missing", async () => {
  ...
  it("rejects Production before the first store read when the trusted business id is missing", async () => {
  ...
  it("rejects Print Export before the first store read when the trusted business id is missing", async () => {
