...
P6-B57 konkretisiert die erste Luecke in `docs/product/P6_B57_LOKALER_START_STATUS_KORRIDOR.md`: Starten -> Status pruefen -> Betriebscheck -> UI-Routen oeffnen -> kontrolliert stoppen wird als lokaler Start-/Status-Korridor mit bestehenden Scripts, URLs, Health-Endpunkten und Reaktion auf rote Signale gebuendelt, ohne Deployment, echte Daten, neue API, Persistenz oder Betriebsplattform einzufuehren.
