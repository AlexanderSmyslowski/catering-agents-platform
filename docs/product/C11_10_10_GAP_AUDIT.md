...
| LLM-Readiness ohne Provider | als kleiner Vertrag weitgehend umgesetzt, weiter ausbaubar | 10/10-Coding-Architektur, PA26-PA36 | Prompt-/Schema-Registry und spaetere synthetic-only Provider-Anbindung fehlen noch; weiterhin keine Runtime |
