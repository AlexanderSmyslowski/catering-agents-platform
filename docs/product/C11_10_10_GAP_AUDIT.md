...
| LLM-Readiness ohne Provider | dokumentiert und geplant | 10/10-Coding-Architektur, PA15/PA18-PA25 | Model-IO, Prompt-/Schema-Registry, Tool-Allowlist und Eval-Fixtures sind noch nicht als kleiner Vertrag umgesetzt |
