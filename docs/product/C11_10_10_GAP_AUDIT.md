...
| LLM-Readiness ohne Provider | als kleiner Vertrag nahezu vollstaendig umgesetzt, weiter ausbaubar | 10/10-Coding-Architektur, PA26-PA37 | synthetic-only ProviderAdapter und spaetere nicht-leere Prompt-Artefakte fehlen noch; weiterhin keine Runtime |
